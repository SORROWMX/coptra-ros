...
Clone this repo to directory `~/catkin_ws/src/coptra`:

```bash
cd ~/catkin_ws/src
git clone <repository_url> coptra
```
...
```bash
cd ~/catkin_ws/src/coptra/coptra/udev
...
```bash
roslaunch coptra coptra.launch
```

For the simulation information see the documentation.
